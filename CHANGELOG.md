...
### Changed
- **GitOps Helm chart pins (#43)**: Default `cluster-bootstrap` to `0.5.17`, `cluster-bootstrap-acm-spoke` to `0.6.13`, and bootstrap `app-of-apps-infrastructure` `targetRevision` to `0.2.3` (aligned with validated-pattern-helm-charts release after AVP/ESO work).
