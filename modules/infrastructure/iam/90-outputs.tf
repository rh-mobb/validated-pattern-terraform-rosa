...
output "secrets_manager_role_arn" {
  description = "ARN of the Secrets Manager IAM role for External Secrets Operator IRSA and temporary AVP vplugin trust (null if enable_secrets_manager_iam is false)"
